<script>
    $(document).ready(function() {
        ...
        var table = $('#datatable').DataTable({
            ...
            ajax: {
                url: 'suplier/data', // URL file untuk proses select datanya
                type: 'POST',
                data: {
            ...
            columnDefs: [
                {
                    ...
                    render: function(data, type, row, meta) {
                        return '<a href="/admin/suplier/edit/' + data + '" class="btn btn-sm btn-primary"><i class="bx bx-pencil me-0"></i></a>' +
                            '<a href="/admin/suplier/delete/' + data + '" class="ms-2 btn btn-sm btn-danger"><i class="bx bx-trash me-0"></i></a>';
                    }
                },
            ],
            pageLength: 25,
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 200) {
                        ...
                        $('#form-suplier').attr('action', '<?= base_url('admin/suplier/edit/'); ?>' + response.data.id_suplier);
