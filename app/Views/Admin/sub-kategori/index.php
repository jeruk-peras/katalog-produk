...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Sub Kategori</div>
        <div class="ps-3">
    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex">
                <div>
                    <h3 class="mb-0 text-uppercase">Data Sub Kategori</h3>
                </div>
                <div class="ms-auto">
...
<div class="modal modal-lg fade" id="modal-form" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="" method="post" id="form-sub-kategori" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="col mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_sub_kategori" name="nama_sub_kategori" placeholder="Masukkan nama sub kategori">
                        <div class="invalid-feedback" id="error_nama_sub_kategori"></div>
                    </div>
                </div>
...
<?= $this->include('Admin/sub-kategori/script'); ?>
<?= $this->endSection(); ?>