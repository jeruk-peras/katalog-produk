            ...
            columnDefs: [
                {
                    ...
                    render: function(data, type, row, meta) {
                        return '<a href="/admin/spesifikasi/edit/' + data + '" class="btn btn-sm btn-warning">edit</a>' +
                            '<a href="/admin/spesifikasi/delete/' + data + '" class="ms-2 btn btn-sm btn-danger"> hapus</a>';
                    }
                },
            ],
            pageLength: 25,
